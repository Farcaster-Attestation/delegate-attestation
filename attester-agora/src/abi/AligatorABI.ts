export default [
  ...
  { inputs: [], name: "ZeroVotesToCast", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [{ internalType: "address", name: "_initOwner", type: "address" }],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "proxyOwner", type: "address" }],
    name: "proxyAddress",
